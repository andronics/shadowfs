...
Tests FileInfo dataclass and VirtualLayer abstract base class.
Target: 95%+ coverage
"""
...
class TestVirtualLayer:
    """Test VirtualLayer abstract base class."""

    def test_virtual_layer_is_abstract(self):
        """VirtualLayer cannot be instantiated directly."""
    ...
    def test_virtual_layer_requires_build_index(self):
        ...
        class IncompleteLayer(VirtualLayer):
    ...
    def test_concrete_layer_can_be_instantiated(self):
        ...
        class ConcreteLayer(VirtualLayer):
            def build_index(self, files):
                self.files = files
        ...
        assert isinstance(layer, VirtualLayer)

    def test_virtual_layer_stores_name(self):
        """VirtualLayer stores the layer name."""
    ...
    def test_virtual_layer_repr(self):
        """VirtualLayer has useful string representation."""
    ...
    def test_refresh_can_be_overridden(self):
        ...
        class IncrementalLayer(VirtualLayer):
            def __init__(self, name):
                super().__init__(name)
