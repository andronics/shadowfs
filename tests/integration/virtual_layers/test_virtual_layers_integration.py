...
from shadowfs.integration.virtual_layers.hierarchical_layer import (
    BuiltinClassifiers as HierarchicalBuiltinClassifiers,
)
...
from shadowfs.integration.virtual_layers.tag_layer import BuiltinExtractors, TagLayer
...
class TestEndToEndWorkflows:
    ...
    def test_multiple_sources(self, tmp_path):
        ...
        manager = VirtualLayerManager([str(src1), str(src2)])
