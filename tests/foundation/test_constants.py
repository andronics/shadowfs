...
class TestEnumerations:
    ...
    def test_virtual_layer_type_values(self):
        ...
        assert VirtualLayerType.CLASSIFIER.value == "classifier"
        assert VirtualLayerType.TAG.value == "tag"
        assert VirtualLayerType.DATE.value == "date"
        assert VirtualLayerType.HIERARCHICAL.value == "hierarchical"
        assert VirtualLayerType.PATTERN.value == "pattern"
        assert VirtualLayerType.COMPUTED.value == "computed"
