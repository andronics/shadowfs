...
from shadowfs.rules.patterns import MultiMatcher, PatternEntry, PatternMatcher, PatternType
...
class TestPatternMatcher:
    ...
    def test_normalize_path(self):
        ...
        # Case insensitive
        assert matcher._normalize_path("Path/To/File.PY", False) == "path/to/file.py"
...
class TestPatternEntry:
    ...
    def test_creation(self):
        ...
        entry = PatternEntry(pattern="*.py", pattern_type=PatternType.GLOB, case_sensitive=True)
    ...
    def test_with_name(self):
        ...
        entry = PatternEntry(pattern="*.py", pattern_type=PatternType.GLOB, name="python_files")
