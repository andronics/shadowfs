...
from shadowfs.core.cache import (
    CacheConfig,
    CacheEntry,
    CacheLevel,
    CacheManager,
...
class TestCacheEntry:
    ...
    def test_is_expired_with_explicit_time(self):
        ...
        with patch("shadowfs.core.cache.time.time", return_value=1010.0):
    ...
    def test_touch(self):
        ...
        with patch("shadowfs.core.cache.time.time", return_value=1005.0):
            entry.touch()
