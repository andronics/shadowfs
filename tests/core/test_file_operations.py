...
from shadowfs.core.constants import ErrorCode, FileAttributes, Limits
from shadowfs.core.file_ops import (
    FileOperationError,
    calculate_checksum,
    copy_file,
    create_directory,
...
class TestFileChecks:
    ...
    def test_file_exists_with_path_error(self):
        ...
        with patch("shadowfs.core.path_utils.normalize_path", side_effect=Exception("Error")):
