...
from shadowfs.core.path_utils import (
    PathError,
    common_path_prefix,
...
class TestIsSafePath:
    ...
    def test_invalid_base(self):
        ...
        with patch("shadowfs.core.path_utils.normalize_path", side_effect=PathError("Invalid")):
...
class TestSplitPath:
    ...
    def test_split_virtual_path(self):
        ...
        with patch("shadowfs.core.path_utils.normalize_path", side_effect=PathError("Virtual")):
