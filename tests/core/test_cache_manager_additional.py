...
from shadowfs.core.cache import CacheConfig, CacheEntry, CacheLevel, CacheManager, LRUCache
...
class TestAdditionalCoverage:
    ...
    def test_global_functions_coverage(self):
        ...
        from shadowfs.core.cache import get_cache_manager, set_global_cache
