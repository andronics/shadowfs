"""
ShadowFS Layers: Base Classes and Data Structures.

This module provides the foundation for the layer system:
- FileInfo: Immutable file metadata structure
- Layer: Abstract base class for all layer implementations

Layers create multiple organizational views over the same files without
...
class Layer(ABC):
    ...
    A layer creates an organizational view over a set of files,
