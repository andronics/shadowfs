...
This module provides the VirtualLayerManager, the central coordinator
...
class VirtualLayerManager:
    """
    Central coordinator for virtual layer operations.

    The manager coordinates all virtual layer functionality:
    ...
    Attributes:
        ...
        layers: Dictionary mapping layer name → VirtualLayer instance
        files: List of all FileInfo objects from scanned sources
    """

    def __init__(self, sources: Optional[List[str]] = None):
        """
        Initialize the virtual layer manager.
        ...
        self.layers: Dict[str, VirtualLayer] = {}
    ...
    def add_layer(self, layer: VirtualLayer) -> None:
        """
        Register a virtual layer with the manager.

        Args:
            layer: VirtualLayer instance to register
    ...
    def get_layer(self, layer_name: str) -> Optional[VirtualLayer]:
        """
...
class LayerFactory:
    ...
    @staticmethod
    def create_date_layer(name: str = "by-date", date_field: str = "mtime") -> "VirtualLayer":
        """
    ...
    @staticmethod
    def create_extension_layer(name: str = "by-type") -> "VirtualLayer":
        """
    ...
    @staticmethod
    def create_size_layer(name: str = "by-size") -> "VirtualLayer":
        """
    ...
    @staticmethod
    def create_tag_layer(name: str = "by-tag", extractors: Optional[List] = None) -> "VirtualLayer":
        """
