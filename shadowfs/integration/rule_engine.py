...
from shadowfs.integration.pattern_matcher import PatternMatcher, PatternType
...
class RuleEngine:
    ...
    def _evaluate_rule(
        self, rule: Rule, path: str, file_attrs: Optional[Dict[str, Any]]
    ) -> bool:
    ...
    def _evaluate_conditions(
        self, rule: Rule, file_attrs: Dict[str, Any]
    ) -> bool:
    ...
    def _evaluate_condition(
        self, condition: Condition, file_attrs: Dict[str, Any]
    ) -> bool:
